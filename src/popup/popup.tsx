...
export const PopupApp: React.FC = () => {
  ...
  const [prs, setPrs] = useState<PRData>({ created: [], assigned: [] });
      ...
      <>
        <div className="header">
          ...
          <div className="header-actions">
            <button onClick={refreshData} className="header-button" title="Refresh">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                <path fillRule="evenodd" d="M8 3a5 5 0 1 0 4.546 2.914.5.5 0 0 1 .908-.417A6 6 0 1 1 8 2v1z"/>
                <path d="M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466z"/>
              </svg>
            </button>
            <button onClick={openSettings} className="header-button" title="Settings">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
    ...
    return (
      <>
        ...
        <div className="setup-needed">
          ...
          <button onClick={openSettings} className="setup-button">Open Settings</button>
        </div>
      </>
    );
  }
  ...
  const currentPRs = prs[activeTab as keyof PRData] || [];
          ...
          {currentPRs.map(pr => (
            ...
            >
              ...
              <div className="pr-meta">
                ...
                <span className="pr-updated">{getTimeAgo(new Date(pr.updated_at))}</span>
              </div>
            </li>
          ))}
        </ul>
